...
@section('content')
    <section class="">
        ...
        <div class="section-body">
            <h5 style="background-color:white; padding:0.4rem; border-radius:1rem;" id="paseSalidaMensaje">Crear usuarios:</h5>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                        @if(Session::has('notiUsuario') )
                            <div  style="max-height: 4.5rem; max-width: 23rem;" class="alert alert-danger alert-dismissible fade show" role="alert">
                              <h5 class="alert-heading">!Hubo un Problema!</h5>
                          ...
                          {{-- <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('idempleado',null,array('class'=>'form-control')) !!}
                          ...
                          <div class="container">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                  <label  style="font-size:16px; font-weight:bold; color:rgb(92, 92, 92)"  for="fk_id_empleado">Username        :</label>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                  <label  style="font-size:16px; font-weight:bold; color:rgb(92, 92, 92)"  for="fk_id_empleado">Email:</label>
                              ...
                              <div class="col-xs-12 col-sm-12 col-md-12">
                                ...
                                <label style="font-size:16px; font-weight:bold; color:rgb(92, 92, 92)" for="name">id Empleado</label>                                    
                                    {!! Form::text('idempleado',null,array('class'=>'form-control')) !!}
                              ...
                              <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <label style="font-size:16px; font-weight:bold; color:rgb(92, 92, 92)" for="name">Roles</label>
                                    {!! Form::select('roles[]', $roles, array('class' => 'form-control')) !!}
                                </div>
                            </div>
