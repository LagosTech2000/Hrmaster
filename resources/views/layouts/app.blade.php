...
<head>
    ...
    <title>@yield('title')| HrMaster</title>    
    <link rel="shortcut icon" type="image/png" href="{{ asset('/img/logoHRmaster.jpeg') }}">
...
<div id="app">
    <div class="main-wrapper main-wrapper-1">
        ...
        <div class="d-lg-block d-none  main-sidebar main-sidebar-postion">
